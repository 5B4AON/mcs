...
/**
 * Settings card — Audio Output (optocoupler keying via sound card).
 *
 * Configures DC-offset or AC-tone keying output through an audio device
 * channel. Includes device/channel selection, mode (DC/AC), frequency,
 * amplitude, wiring hints, and a test button.
 */
@Component({
  selector: 'app-audio-output-card',
  standalone: true,
  imports: [FormsModule],
  templateUrl: './audio-output-card.component.html',
  styles: [':host { display: contents; }'],
})
export class AudioOutputCardComponent {
